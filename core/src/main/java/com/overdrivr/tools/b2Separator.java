...
public class b2Separator {
	...
	*/
    ...
    public void separate(Body body, FixtureDef fixtureDef, Vector2[] verticesVec)
    {
        ...
        Gdx.app.log("b2Separator","Shapes :"+Integer.toString(n));
    ...
    private ArrayList<ArrayList<Vector2>> calcShapes(ArrayList<Vector2> verticesVec) {
        ...
        while(queue.size() > 0)
        {
            Gdx.app.log("b2Separator","Queue size :"+Integer.toString(queue.size()));
            vec = queue.get(0);
            n = vec.size();
            Gdx.app.log("b2Separator","Points amounts :"+Integer.toString(vec.size()));
            isConvex = true;
            ...
            if(isConvex) {
                ...
                Gdx.app.log("b2Separator","Found concave shape");
            }
        }
        return figsVec;
    }
