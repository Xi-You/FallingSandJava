...
public class MenuInputProcessor implements InputProcessor {
    ...
    private void createDropdownStage() {
        ...
        FileHandle atlasFileHandler = new FileHandle(String.valueOf(Gdx.files.internal("uiskin.atlas"))); 
        FileHandle skinFileHandler = new FileHandle(String.valueOf(Gdx.files.internal("uiskin.json")));
        FileHandle imagesFileHandler = new FileHandle(String.valueOf(Gdx.files.internal("uiskin.png")));
